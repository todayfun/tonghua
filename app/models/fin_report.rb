...
=begin
    ...
    营业收入：idx1
    基本每股收益:idx-2,fd_profit_base_share
    稀释每股收益:idx-1
...
=end
  def self.import_us_finRpt stock
    ...
    cols.each_with_index do |col,idx|
      ...
      records[idx][:fd_non_liquid_debts] = debt_report[-5][col]
      records[idx][:fd_liquid_debts] = debt_report[-7][col]
      records[idx][:fd_liquid_assets] = debt_report[7][col]
    end
...
=begin
  ...
  基本每股盈利:fd_profit_base_share
  每股股息：fd_dividend_base_share
  ...
  非流动负债: fd_non_liquid_debts
  股东权益: fd_stkholder_rights

  流动负债:fd_liquid_debts
  流动资产: fd_liquid_assets

  现金及银行结存:fd_cash_and_bankdeposit
